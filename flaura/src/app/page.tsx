...
export default function Home() {
  return (
    <div className="hero w-full bg-transaparent min-h-screen flex flex-col bg-cover bg-center -z-20 justify-start items-start">
      <div id="home" className="z-0 px-[20px] md:px-20 w-full flex sm:flex-row flex-col-reverse justify-end items-end lg:pt-[300px] pt-[150px] gap-5 lg:pb-[120px]">
        <div className="flex items-end flex-col">
          <h1 className="xl:text-9xl lg:text-8xl md:text-7xl text-5xl font-cera-pro font font-thin">Flaura.AI</h1>
          <div className="divider mt-0"></div>
          <p className="lg:text-xl md:text-2xl font-normal text-xl text-end">Where the elegance of simplicity meets the power of AI. Transform your data experience with a beautiful, intuitive spreadsheet that’s as smart as it is stylish.</p>
          <div className="pt-5 flex flex-col justify-end items-end gap-4">
      ...
      <div className="z-0 w-full flex flex-col md:px-[80px] px-[20px] justify-start items-center lg:pt-[300px] pt-[150px] gap-20 pb-[120px]">
        <div className="">
          <Image className="z-0 w-full" src={Demo} width={160} height={60} alt="Logo" />

        </div>
        <div id="product" className="bg-[#c2c2c2] bg-opacity-25 w-full border-[1px] border-[#acaaaa] lg:pb-10 lg:pt-16 py-8 lg:px-10 px-6 rounded-3xl flex flex-col gap-2">
      ...
      <div id="team" className="z-0 w-full pb-[0px] flex flex-col md:px-[80px] px-[20px] justify-start pt-[200px] gap-20">
        <div className="">
        <h1 className="text-8xl text-center font-cera-pro font-thin">Our Team</h1>
        </div>
        <div className="grid md:grid-cols-12 grid-cols-4 md:gap-x-6 gap-y-4 md:gap-y-8">
        <div className="col-span-4 backdrop-blur-md bg-[#c2c2c2] bg-opacity-25 border-[1px] border-[#acaaaa] py-10 px-10 rounded-3xl flex flex-col">
          ...
          <h2 className="text-3xl">Jirawan Fai Makcharoensub</h2>
          <div className="divider bg-white h-[3px]"></div>
          <h2 className="text-3xl pb-2">Co-CEO</h2>
        ...
        <div className="col-span-4 backdrop-blur-md bg-[#c2c2c2] bg-opacity-25 border-[1px] border-[#acaaaa] py-10 px-10 rounded-3xl flex flex-col">
          ...
          <h2 className="text-3xl">Natakorn Jedi Wannabovorn</h2>
          <div className="divider bg-white h-[3px]"></div>
          <h2 className="text-3xl pb-2">Co-CEO</h2>
        ...
        <div className="col-span-4 backdrop-blur-md bg-[#c2c2c2] bg-opacity-25 border-[1px] border-[#acaaaa] py-10 px-10 rounded-3xl flex flex-col">
          ...
          <h2 className="text-3xl">Nuttahapong Dev Sachthep</h2>
          <div className="divider bg-white h-[3px]"></div>
        ...
        <div className="col-span-4 backdrop-blur-md bg-[#c2c2c2] bg-opacity-25 border-[1px] border-[#acaaaa] py-10 px-10 rounded-3xl flex flex-col">
          ...
          <h2 className="text-3xl">Patthadon Arm Aroonpairodjanakul</h2>
          <div className="divider bg-white h-[3px]"></div>
        ...
        <div className="col-span-4 backdrop-blur-md bg-[#c2c2c2] bg-opacity-25 border-[1px] border-[#acaaaa] py-10 px-10 rounded-3xl flex flex-col">
          ...
          <h2 className="text-3xl">Puttisan Art Korsettarat</h2>
          <div className="divider bg-white h-[3px]"></div>
